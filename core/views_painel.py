...
from . import painel_acoes, painel_dados, painel_modulos
    ...
    return JsonResponse(
        {
            ...
            **painel_dados.listar(
            ...
            # Acoes de fluxo do modulo (abrir chamado, nova pendencia): quando
            # existem, substituem a criacao generica, que pularia as regras.
            "acoes": painel_acoes.acoes_serializadas(tabela.chave, "tabela"),
        }
    )
