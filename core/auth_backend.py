...
from .permissions import ensure_user_permission_defaults
...
class ActiveDirectoryBackend:
    """Authenticate users against Active Directory over LDAP."""
    ...
    def authenticate(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            logger.exception("Failed to query Active Directory for username=%s", username)
            return None
        ...
        try:
            ...
            logger.warning("Invalid Active Directory credential for username=%s", username)
            return None
        ...
        try:
            ...
            logger.exception("Failed to sync local user after Active Directory auth for username=%s", username)
            return None
