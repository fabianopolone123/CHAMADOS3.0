...
MODULOS: tuple[ModuloPainel, ...] = (
    ...
    ModuloPainel(
        chave="emprestimos",
        tabelas=("emprestimos", "equipamentos"),
        nota="Termo em PDF, assinatura e anexos continuam na tela de Emprestimos.",
    ),
    ModuloPainel(chave="documentos", tabelas=("documentos",), nota="Os anexos continuam na tela de Documentos."),
    ...
    ModuloPainel(chave="servicos_feitos", tabelas=("servicos",), nota="Os anexos de NF/orcamento continuam na tela do modulo."),
    ModuloPainel(chave="contratos_ti", tabelas=("contratos_ti",), nota="Os anexos continuam na tela de Contratos."),
    ...
    ModuloPainel(
        ...
        nota="As senhas so abrem no Cofre, com a senha-mestra. Aqui aparecem apenas os metadados.",
    ),
    ModuloPainel(
        chave="email_config",
        area="operacao",
        nota="A configuracao SMTP e o e-mail de teste continuam na tela de E-mail.",
    ),
