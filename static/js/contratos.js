(function () {
    ...
    function fmtRawMoney(raw, moeda) {
        return RequisicaoTexto.moeda(raw, moeda);
    }

    // O texto do WhatsApp e do e-mail (e a copia em si) vivem em
    // `requisicao_texto.js`, compartilhado com o terminal do Painel do Titular:
    // a mesma mensagem em dois lugares tinha de sair de uma fonte so.
    function buildWhatsappMessage(data) {
        return RequisicaoTexto.whatsapp(data);
    }

    async function copyText(text) {
        return RequisicaoTexto.copiar(text);
    }
    ...
    function buildEmailPlainText(data) {
        return RequisicaoTexto.emailTexto(data);
    }
