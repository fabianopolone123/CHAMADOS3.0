...
- Painel do Titular em `/painel/` (apenas `fabiano.polone`): terminal de administracao por teclado, no estilo dos sistemas de banco, com interface do menu, usuarios e acessos, dados de todos os modulos e operacao/manutencao, tudo auditado
...
- Modulos Contatos e Kaspersky (removidos em 30/07/2026 para serem refeitos; os dados importados ficaram no banco)
