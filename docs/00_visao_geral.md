...
- **API para sistemas de fora** (`docs/09_api.md`): token no cabecalho, leitura generica em `/api/v1/tabelas/...` e escrita pelas mesmas rotas da tela — inclusive envio e download de arquivo
