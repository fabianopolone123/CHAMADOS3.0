...
5. O vinculo computador -> colaborador e resolvido **pelo nome do usuario do GLPI**, comparando o **conjunto de palavras** sem acento, em quatro passos: (a) conjunto identico; (b) um nome contido no outro com pelo menos 2 palavras em comum - resolve a inversao ("Gabriele Ana" x "Ana Gabriele") e nomes do meio a mais ("Garbuio Tamara Cristiane" x "Tamara Garbuio"); (c) 1 palavra igual + 1 palavra **parecida**, para grafia diferente do sobrenome ("Vich Everaldo" x "Everaldo Vichi", "Giamlourenco Marcelo" x "Marcelo Giannourenco"), com semelhanca minima de 82% e desprezando palavras de menos de 4 letras; (d) nome de **uma palavra so** (ex.: "portaria") casa apenas por igualdade exata. Em todos os passos exige-se **um unico** candidato. Na duvida, o computador fica sem dono e o vinculo e feito a mao clicando no computador na tela - **vinculo errado e pior que vinculo nenhum**, porque a pessoa sai silenciosamente do relatorio de quem esta sem antivirus (foi o caso de "Silva Andre", com varias "Silva" na lista).
