...
- `core`: app responsavel pela autenticacao, rotas principais, Kanban, portal do solicitante, permissoes, historico, modulo Requisicoes (nomes tecnicos internos com prefixo `Contrato`) e modulo Insumos
...
- `static/js`: scripts do front-end (`chamados.js` do Kanban, `contratos.js` do modulo Requisicoes, `insumos.js` do modulo Insumos e `notifications.js` dos toasts)
